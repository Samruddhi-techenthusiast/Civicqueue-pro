...
// multer throws a MulterError (e.g. LIMIT_FILE_SIZE) directly, not via our ApiError
// class, so without this it was falling into the generic "unknown error" 500 branch.
const handleMulterError = (err) => ApiError.badRequest(`Upload error: ${err.message}`);
