 ...
 *   patch:
 *     tags: [Departments]
 *     summary: Admin configures department queue settings (avg service time, max size, counters)
 *     requestBody:
 *       content:
 *         application/json:
 *           schema:
 *             type: object
 *             properties:
 *               avgServiceTimeMinutes: { type: integer, minimum: 1, maximum: 120 }
 *               maxQueueSize: { type: integer, minimum: 1, maximum: 2000 }
 *               activeCounters: { type: integer, minimum: 1, maximum: 50 }
 */
