...
/**
 * @swagger
 * /appointments/department/{departmentId}/board:
 *   get:
 *     tags: [Appointments]
 *     summary: Staff dashboard board — pending (any date), today, upcoming, completed, cancelled
 */
router.get('/department/:departmentId/board',
  authenticate, authorize('staff', 'admin', 'super_admin'), sameDepartment,
  ctrl.getDeptBoard);
